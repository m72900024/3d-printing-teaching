window.COURSES = [
  ...
  },
  {
    ...
    sections:[
      {title:"先找出所有 FDM 都有的工作系統",body:"不要先背品牌或型號。面對任何一台 FDM 印表機，都可以沿著材料的旅程觀察：線材從線架出發，經過送料與導引，進入熱端熔化，再由噴嘴鋪到列印平台上。",partGallery:[
        {label:"供料",title:"線架與線材捲盤",src:"../assets/course-02/anime-parts/01-filament-supply.webp",alt:"日本動漫風格彩色插圖：多捲線材由線架順暢供應至 FDM 印表機",text:"線架讓捲盤順暢轉動。線材若纏結、阻力太大或路徑被折彎，就可能造成送料不穩。",look:"先找圓形捲盤，再沿著紫色線材確認它如何離開捲盤、進入導引路徑。",credit:"GPT 繪製彩色教學圖"},
        {label:"送料",title:"擠出機與導引路徑",src:"../assets/course-02/anime-parts/02-extruder-feed.webp",alt:"日本動漫風格彩色剖面圖：擠出齒輪夾住線材並向下送料",text:"擠出機用齒輪推送線材；有些裝在噴頭上，有些裝在機架上，再經導管送到熱端。",look:"藍色線材從上方進入，中央兩個齒輪夾住它，持續把材料送往下方熱端。",credit:"GPT 繪製彩色教學圖"},
        {label:"加熱",title:"熱端、加熱塊與噴嘴",src:"../assets/course-02/anime-parts/03-hotend-nozzle.webp",alt:"日本動漫風格彩色插圖：熱端散熱片、發熱塊與黃銅噴嘴正在擠出線材",text:"熱端把線材加熱到可流動狀態，噴嘴控制擠出位置。列印中與結束後一段時間都可能燙傷。",look:"由上往下找散熱片、橘色發熱塊和黃銅噴嘴；發光區域提醒這裡不能用手觸碰。",credit:"GPT 繪製彩色教學圖"},
        {label:"承托",title:"熱床與列印平台",src:"../assets/course-02/anime-parts/04-heated-bed.webp",alt:"日本動漫風格彩色插圖：噴嘴在加熱平台上鋪設平整的彩色第一層",text:"平台承托第一層；熱床提供適當溫度幫助附著。平台也可能移動，因此不能只注意噴頭。",look:"彩色平行線就是第一層；下方橘色熱流表示平台正在加熱並幫助材料黏附。",credit:"GPT 繪製彩色教學圖"}
  ...
  {
    id:"03", slug:"03-workflow.html", stage:"第一次成功", stageNo:"01", duration:"12 分鐘", type:"全貌＋流程",
    title:"從模型到成品", subtitle:"需求、建模、切片、列印，一路看懂檔案如何變成作品。",
    lead:"3D 列印不是把模型檔丟進機器就完成。每一件作品都會經過設計、翻譯與製造；先看懂每一步的輸入與輸出，就不容易在檔案、軟體和印表機之間迷路。",
    goals:["排列需求、建模、切片、列印的完整順序","說明切片如何把模型翻譯成列印路徑","分辨模型檔、切片專案與機器指令"],
    lessonVisual:{src:"../assets/course-03/anime/00-workflow-overview.webp",width:1200,height:800,alt:"日本動漫風格彩色插圖：同一個桌面收納盒依序經過建模、彩色切片與 FDM 列印",caption:"同一件作品一路變身：左邊建立形狀，中間把形狀翻譯成逐層路徑，右邊才交給印表機製造成品。",guides:[["建立模型","從需求出發，自己設計或取得合適的數位模型。"],["切片翻譯","設定材料與列印方式，再逐層檢查噴嘴路徑。"],["列印驗證","傳送正確指令、觀察第一層，完成後檢查成品。"]]},
    sections:[
      {title:"第一步：從需求到 3D 模型",body:"先問自己要解決什麼問題，再用 Tinkercad、Fusion、Onshape 等建模工具建立形狀；也可以從可信任的模型網站取得作品。輸出前要檢查尺寸、單位、零件是否完整，以及模型是否為可列印的封閉實體。常見模型格式是 STL 與 3MF。",workflowVisual:{label:"STEP 01 · MODEL",src:"../assets/course-03/anime/01-modeling.webp",alt:"日本動漫風格彩色插圖：學生從文具收納需求、草圖與基本形狀建立桌面收納盒 3D 模型",caption:"先決定作品要解決的問題，再把草圖與尺寸轉成電腦中的立體幾何。",facts:[["輸入","需求、草圖、尺寸，或取得授權的模型。"],["主要動作","建立、組合、量測並檢查封閉幾何。"],["輸出","可供切片使用的 STL 或 3MF 模型檔。"]]}},
      {title:"第二步：切片軟體負責翻譯",body:"切片軟體（例如 Bambu Studio、OrcaSlicer、Cura 或 PrusaSlicer）會依照印表機、噴嘴、材料、層高、外殼、填充與支撐設定，把立體模型轉成噴嘴逐層移動的路徑。切片後不能只看時間；還要播放逐層預覽，找出浮空、缺層、不必要支撐或錯誤方向。",workflowVisual:{label:"STEP 02 · SLICE",src:"../assets/course-03/anime/02-slicing.webp",alt:"日本動漫風格彩色插圖：學生在品牌中立的切片軟體中查看桌面收納盒的外殼、填充、支撐與逐層預覽",caption:"切片不是把模型切壞，而是把幾何翻譯成機器可以一層一層執行的路徑。",facts:[["輸入","模型檔、印表機與噴嘴、材料及列印設定。"],["主要動作","計算外殼、填充、支撐與每一層路徑。"],["輸出","切片專案，以及印表機可執行的路徑指令。"]]}},
      {title:"第三步：傳送、觀察與完成列印",body:"確認工作送到正確的印表機，平台上沒有舊作品或工具，線材與設定也彼此相符，再啟動必要的機器檢查。開始後留在旁邊觀察第一層：線條應連續、平整並穩定黏附；若被拖走或堆成亂線，先暫停。完成後等平台降溫，再安全取下並檢查尺寸與表面。",workflowVisual:{label:"STEP 03 · PRINT",src:"../assets/course-03/anime/03-printing.webp",alt:"日本動漫風格彩色插圖：學生保持安全距離觀察 FDM 印表機製作桌面收納盒，旁邊放著已冷卻成品",caption:"印表機只是執行切片指令；第一層與最後成品會告訴我們前面的決定是否正確。",facts:[["輸入","已確認的列印路徑、正確材料與可用平台。"],["主要動作","傳送、機器檢查、觀察第一層與安全等待。"],["輸出","可以量測、測試與回饋修改的實體作品。"]]}}
    ],
    task:{title:"流程配對",text:"準備四張紙，分別寫上「需求／草圖」、「STL 或 3MF」、「切片軟體」與「印表機路徑指令」，排成正確順序；再說明每一步的輸入、主要動作與輸出。"},
