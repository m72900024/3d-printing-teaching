window.COURSES = [
  {
    ...
    sections:[
      {title:"3D 列印到底做了什麼？",body:"傳統加工常從一整塊材料切除不要的部分；3D 列印則從空無一物開始，只在需要的位置加上材料，因此也稱為「加法製造」。",manga:{src:"../assets/course-01/manga/additive-manufacturing-manga.webp",alt:"日系漫畫三格圖：切削加工與逐層堆疊的對比、數位模型轉成實體，以及快速迭代三個原型",caption:"從切除材料到逐層增加，再把數位模型快速做成可測試的實體。"},cards:[
